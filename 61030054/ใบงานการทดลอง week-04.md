...
ผลการทดลองเป็นอย่างที่คิด หน้าจอแสดงข้อความถูกต้อง
...
Console.Write() จะแสดงข้อความแบบบรรทัดเดียว
Console.WriteLine() จะแสดงข้อความแบบเว้นบรรทัด
...
เป็นการระบุตำแหน่งตัวแปรที่ต้องการแสดง
...
Console.WriteLine("{0, 3}", 1);
("{0, 3}", 1 >>> เลขศูนย์คือลำดับตัวแปรที่ต้องการแสดง 
เลขสามคือตำแหน่งที่ต้องการให้ตัวเลขแสดงผลออกบนหน้าจอเมื่อรันโปรแกรม 
เลขหนึ่งคือตัวแปรที่กำหนดไว้
...
ผลคือ แสดงตัวอักษรตัวแรกตัวเดียวเพราะคำสั่ง Char 
คือการเก็บตัวอักษรเพียงตัวเดียวหากอยากให้แสดงข้อความทั้งบรรทัดให้ใช้ String
...
โปรแกรมสามารถรันได้ตามปกติแต่จะมีแจ้งเตือนว่าข้อมูลที่ต้องการแสดงคือชนิดไหน
...
เกิด error ขึ้น ป้องกันโดยใช้เงื่อนไข if…else หรือ try{…} catch{…}
![](images/16.PNG)
...
โปรแกรมที่รันจะแจ้งเตือน error
![](images/18.PNG)
...
| `time` |ใช้ไม่ได้ |มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `do` |ช้ไม่ได้ |มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
