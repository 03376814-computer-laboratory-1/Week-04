...
เป็นไปตามที่คิดไว้เพราะรันแล้วได้ผลลัพธ์ตามโค๊ดที่ใส่ไป
...
Console.Write() เวลารันตัวหนังสือจะติดกันไม่ขึ้นบรรทัดใหม่
 Console.WriteLine() เวลารันตัวหนังสือจะขึ้นบรรทัดให้ใหม่
...
เป็นเหมือนกับที่เก็บตัวแปร

❔ ถ้ามีการใช้ตัวเลขใน { } ที่กระโดด เช่น {0} {2} {3} จะใช้งานได้หรือไม่ อย่างไร จงอธิบาย

 โปรแกรมจะขึ้นผลลัพธืดังในภาพเนื่องจากโปรแกรมจะนับเรียงตั้งแต่ 0-9 ห้ามใช้เลขโดด
![](images/7.PNG)
...
❔ การกำหนดความกว้างของอาร์กิวเมนต์ด้วยเครื่องหมาย { , } ในคำสั่ง ``Console.WriteLine()`` มีรูปแบบการใช้งานอย่างไร
 ...
 เป็นเหมือนการเคาะ Space Bar ตามจำนวนครั้งที่ใส่ไปในโค๊ด
...
![](images/33.PNG)
วิธีป้องกันคือควรเปลี่ยนการกำหนดตัวแปรให้ตรงกัน หรือระบุให้ชัดว่าต้องป้อนเป็นตัวเลขเท่านั้น
...
| `null`| ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `_value`| ใช้ไม่ได้ | ละเมิดกฎการตั้งชื่อคืออักษรตัวแรกห้ามเป็นเครื่องหมาย |
| `First-name`| ใช้ไม่ได้ | มีตัวอักษรที่ละเมิดกฎการตั้งชื่อคือ - |
| `Hello!`| ใช้ไม่ได้ | มีตัวอักษรที่ละเมิดกฎการตั้งชื่อคือ ! |
| `w*h` | ใช้ไม่ได้ | มีตัวอักษรที่ละเมิดกฎการตั้งชื่อคือ * |
| `time`| ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `do` | ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `Do` | ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `21November`| ใช้ไม่ได้ | ละเมิดกฎการตั้งชื่อคืออักษรตัวแรกห้ามเป็นตัวเลข |
| `ladkrabang`| ใช้ได้ | ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ |
| `Student ID`| ใช้ไม่ได้ | ละเมิดกฎการตั้งชื่อคือห้ามเว้นวรรค |
...
|---|---|---|---|
| Mercury | 57,910,000 km |0.39 |3.22
| Venus | 108,200,000 km | 0.72|6.02
| Earth | 149,600,000 km |1 |8.33
| Mars | 227,940,000 km | 1.52|12.69
| Jupiter |  778,330,000 km | 5.20|43.34
| Uranus | 2,873,550,000 km |19.21|159.99
| Neptune | 4,501,000,000 km | 30.09|250.61
| Pluto | 5,945,900,000 km | 39.75|331.06
